...
export default function Login() {
  ...
  const [error, setError] = useState(params.get('error') ? 'OAuth sign-in failed. Please try again or use email/password.' : '');
      ...
      <div className="auth-card">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 20 }}>
          ...
          <OAuthButton
            ...
            bg="#24292e" color="#fff" border="#24292e"
          >
            <GitHubIcon color="#fff" /> Continue with GitHub
          </OAuthButton>
        </div>
